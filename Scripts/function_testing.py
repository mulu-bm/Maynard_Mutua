...
def user_input(data):
    ...
    data = 'fire probability'

    if data == 'fire probability':
        
        user_input_model = arcpy.GetParameterAsText(1)
        user_input_scenario = arcpy.GetParameterAsText(2)
        time_selection = arcpy.GetParameterAsText(3)
        def fire_input(user_input_model, user_input_scenario, time_selection):
    ...
    elif data == 'flood plain':
    
    elif data == 'extreme heat':
        
    elif data == 'sea level rise':
